    ...
    try {
      ...
      if (newImageAssets.length > 0) {
          for (const asset of newImageAssets) {
             ...
             if (!currentInMemoryImages.has(normalizedPath)) {
                 currentInMemoryImages.set(normalizedPath, {
                     name: normalizedPath,
                     blob: asset.file,
                     width: finalW,   
      ...
      <main className="max-w-5xl mx-auto space-y-8">
        ...
        {report && (
          <div className="space-y-6">
            ...
            <div className="sticky top-0 z-40 bg-gray-900 -mx-6 px-6 pt-6 pb-6 border-b border-gray-800 shadow-md transition-all">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center bg-gray-800 p-1 rounded-lg border border-gray-700 shadow-sm">
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-gray-300 hover:text-white hover:bg-gray-700 rounded-lg transition-colors"
                  ...
                  <div className="w-full md:w-[420px] relative group">
                    ...
                    <input
                      ...
                      className="w-full py-2.5 pl-10 pr-10 text-sm text-gray-200 transition-all border border-gray-700 rounded-xl bg-gray-800/50 focus:outline-none focus:ring-1 focus:ring-spine-accent/50 focus:border-spine-accent/50 placeholder:text-gray-600 focus:bg-gray-800"
                    />
                    {searchTerm && (
                      <button 
                ...
                {/* ROW 2: Reset/Clear and Docs/Optimize */}
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  {/* Left: Reset/Clear */}
                  <div className="flex items-center gap-2">
                    {hasUserChanges && (
                      <button 
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-white bg-orange-600 hover:bg-orange-500 rounded-xl transition-all shadow-lg shadow-orange-900/20 active:translate-y-0.5"
                    ...
                    {selectedKeys.size > 0 && (
                      <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 text-sm font-bold text-gray-300 bg-gray-800 border border-gray-700 rounded-xl hover:bg-gray-700 hover:text-white transition-colors"
                      >
                        <CheckSquare size={16} className="text-spine-accent" />
                        <span>Clear Selection ({selectedKeys.size})</span>
                      </button>
                    )}
                  </div>

                  {/* Right: Documentation/Optimize (Matched width to Search) */}
                  <div className="w-full md:w-[420px] flex items-center gap-3">
                    <button
                      type="button"
                      onClick={() => setIsTrackModalOpen(true)}
                      className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-bold text-gray-200 bg-gray-800 border border-gray-600 rounded-xl hover:bg-gray-700 hover:text-white hover:border-gray-500 transition-all shadow-sm group"
                    >
                    ...
                    {report.animations.length > 0 && activeImageCount > 0 && (
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-bold text-white transition-all rounded-xl bg-blue-600 hover:bg-blue-500 shadow-lg shadow-blue-900/20 hover:shadow-blue-900/40 hover:-translate-y-0.5 active:translate-y-0"
                      >
